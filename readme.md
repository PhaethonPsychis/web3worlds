...
1. A contract to ask for sponsorships in the form of tokens from existing applications & protocols that form the web3 ecosystem which gives them exposure to the worldbuilding project.  Here’s a link to a project that inspired this protocol[GitHub Pages](https://pages.github.com/). <br>
